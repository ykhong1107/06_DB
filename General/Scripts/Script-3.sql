...
COMMENT ON COLUMN "MESSAGE"."SEND_TIME" IS '메시지 보낸시간';

COMMENT ON COLUMN "MESSAGE"."SENDER_NO" IS '메시지 보낸 회원번호';
...
ALTER TABLE "CHATTING_ROOM" ADD CONSTRAINT "FK_MESSAGE_TO_CHATTING_ROOM_1" FOREIGN KEY (
	"MESSAGE_NO"
)
REFERENCES "MESSAGE" (
	"MESSAGE_NO"
