...
FROM	EMPLOYEE
-- WHERE HIRE_DATE BETWEEN '2010-01-01' AND '2019-12-31' 보다는 아래꺼가 낫다
...
-- 문자열 또는 숫자를 날짜형식으로 변환

SELECT 
	'2024-08-16' 문자열,
	TO_DATE('2024-08-16') 날짜
FROM DUAL;
-- TO_DATE에 매개변수가 한개만 작성될 수 있는 경우
...
-- RPAD(문자열, 길이, 바꿀문자)
--   : 문자열 전체에서 오른쪽을 지전된 길이만큼 다른 문자로 변경
...
-- 4091140.86956521739130434782608695652174 를 FLOOR로 감싸기
