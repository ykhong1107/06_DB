...
-- 해결방법1) 참조하는 자식테이블 (TB2)를 먼저 삭제하거나 FK 제약조건을 삭제
 
-- 해결방법2) CASCADE CONSTRIANTS 옵션 사용하기
--> 테이블 삭제시 연결되어있는 FK 제약조건을 같이 삭제시킴
